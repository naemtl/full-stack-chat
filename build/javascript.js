...
/* harmony import */ var _ChatForm_jsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ChatForm.jsx */ "./src/ChatForm.jsx");
...
class UnconnectedChatForm extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
...
let ChatForm = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(UnconnectedChatForm);
  ...
  constructor(...args) {
    ...
    _defineProperty(this, "render", () => {
      let msgToElement = msg => {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, msg.username, ": ", msg.message, " posted at ", msg.timestamp);
      };

      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, this.props.messages.map(msgToElement));
    });
  }
...
class UnconnectedLogin extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
    ...
    _defineProperty(this, "handSubmit", async event => {
      event.preventDefault();
      ...
      let responseBody = await response.text();
      console.log("login path response body", responseBody);
...
class UnconnectedSignup extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
...
let Signup = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(UnconnectedSignup);
...
react_dom__WEBPACK_IMPORTED_MODULE_0___default.a.render(react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_5__["Provider"], {
